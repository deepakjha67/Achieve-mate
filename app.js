...
// --- GUEST/AUTH UTILITY ---
// Returns true if user is logged in, otherwise opens login modal
...
function checkReminders() {
    ...
    // Use localStorage to prevent multiple notifications in the same hour block
    // Key format: 'last_reminder_YYYY-MM-DD-HOUR'
...
// Check more frequently (every 10 seconds) so we don't miss the minute, but guard with localStorage
...
function init() {
    ...
    // NOTE: Auth logic is handled in firebase.js onAuthStateChanged. 
    // We do NOT force auth modal here anymore to allow Guest access.
}
...
function renderPlaylists() {
    ...
    // GUEST ACTION MODIFICATION: REMOVED CHECK AUTH
